            ...
            <form method="post">
                <div class="card">
                    ...
                    <div class="card-footer text-muted">
                        <a class="btn btn-outline-dark" href="${pageContext.request.contextPath}/Admin/Project"
                           role="button">
                        ...
                        <c:otherwise>
                            <div class="card-footer text-muted">
                                ...
                                <button type="submit" class="btn btn-outline-dark" formaction="${pageContext.request.contextPath}/Admin/Project/Public">
